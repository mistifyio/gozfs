...
func main() {
	...
	cmdList.Flags().StringP("types", "t", "", "Comman seperated list of dataset types to list.")
	...
	cmdGet.Flags().StringP("types", "t", "", "Comman seperated list of dataset types to list.")
